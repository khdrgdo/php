...
<hr>
<h3><font color="green"><?php echo $row['sy'];  ?></font></h3>
...
<?php }}else{
echo 'No Schedule Available on MWF';
} ?>
	  </tr>
  </tbody>
</table>
	...
	<!-- <form method="POST" action="exam_excel_CYS.php">
	<input type="hidden" name="id_get" value="<?php echo $CYS; ?>">
